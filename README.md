...
Please upload the source code to GitHub (you can make a public repo, make sure I have no problem rebuilding the app from the source code) and send me the link to it by end of day Sunday, 17 December 2017. Send me a copy of the apk file too just in case. Also, your work here will involve some API design and database design(SQL), so make sure you prepare for it.
